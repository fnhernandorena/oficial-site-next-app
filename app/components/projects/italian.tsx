...
export default async function Projects() {
  ...
  return (
    ...
    {pro?.map((project) =>
        <div  data-aos={dir == 0 && "fade-up-right" || dir == 1 && "fade-up-left"} className="w-full md:w-5/12 bg-black rounded-xl p-3 m-3 flex flex-col justify-between items-center" key={project.id}>
