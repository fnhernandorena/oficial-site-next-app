...
export default async function Projects() {
  ...
  return (
    ...
    {pro?.map((project) =>
        <div  data-aos={dir == 0 && "fade-up-right" || dir == 1 && "fade-up-left"} className="w-full md:w-5/12 bg-black rounded-xl p-3 m-3 flex flex-col justify-around items-center" key={project.id}>
  ...
  <Image
    ...
    height={960}
  />
    <p className="text-white text-center">{project.cuerpoeng}</p>
