...
const links = [
  { name: "Sobre mi", icon: FaHouseUser, href: "/spanish" },
  {
    name: "Formacion Academica",icon: HiMiniAcademicCap,
    href: "/spanish/studies",
  },
  {
    name: "Proyectos",icon: IoDesktopSharp,
    href: "/spanish/projects"
  },
  { name: "Experiencia laboral",icon: FaTools, href: "/spanish/work-experience" },
  { name: "Contacto", icon: IoCall, href: "/spanish/contact" },
];
