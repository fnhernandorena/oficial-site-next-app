    ...
    <main className="flex-1 h-full flex bg-black pb-48">
      <div className="w-full h-full flex justify-center content-center flex-col p-9">
        <b className='flex justify-center'>
          <h1 className={`my-tit text-center p-8 mt-20 mb-16 bg-sky-600 rounded-full text-3xl md:text-5xl w-full text-white ${loaded ? 'tit-loaded' : ''}`}>
            Hi! I`m Francisco Hernandorena <i className="fa-solid fa-code"></i>
          </h1>
        </b>
        <div className="flex flex-1 flex-wrap justify-center">
          <div className={`my-component my-3 bg-gray-900 transition-linear duration-300 text-white w-full py-5 flex items-center md:justify-around rounded-xl font-medium border-2 border-solid border-sky-600  md:m-5 md:py-30 text-xl flex-col md:w-72 md:h-72 md:rounded-3xl ${loaded ? 'loaded' : ''}`}>
