  ...
  return (
    <main className="flex-1 flex mx-2">
      <ul className="text">
        ...
        <li><h3 className="text-3xl font-bold text-sky-300 border-double border-b-8 border-r-8 border-sky-300">Download my resume</h3>
        <Link href="/documents/FranciscoHernandorenaResume.pdf" className="flex justify-center rounded-xl bg-sky-700 md:bg-gray-800 duration-300 hover:bg-sky-700 m-3 p-3">Click here!</Link>
          </li>
      </ul>
    </main>
  );
